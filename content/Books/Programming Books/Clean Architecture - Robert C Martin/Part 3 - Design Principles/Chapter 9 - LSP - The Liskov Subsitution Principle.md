...
modified: 2024-10-29T20:46:30-04:00
title: Chapter 9 - LSP - The Liskov Subsitution Principle
tags:
  - srp
  - design-systems
  - architecture
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN09.jpg)

In 1988, Barbara Liskov wrote the following as a way of defining subtypes.

_What is wanted here is something like the following substitution property: If for each object o1 of type S there is an object o2 of type T such that for all programs P defined in terms of T, the behavior of P is unchanged when o1 is substituted for o2 then S is a subtype of T_.[1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9.xhtml#ch9fn1)

To understand this idea, which is known as the Liskov Substitution Principle (LSP), let’s look at some examples.

### GUIDING THE USE OF INHERITANCE

Imagine that we have a class named `License`, as shown in [Figure 9.1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9.xhtml#ch9fig1). This class has a method named `calcFee()`, which is called by the `Billing` application. There are two “subtypes” of `License`: `PersonalLicense` and `BusinessLicense`. They use different algorithms to calculate the license fee.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/09fig01.jpg)
...
The canonical example of a violation of the LSP is the famed (or infamous, depending on your perspective) square/rectangle problem ([Figure 9.2](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9.xhtml#ch9fig2)).

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/09fig02.jpg)
...
[Click here to view code image](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9_images.xhtml#pch9ex01a)
...
[Click here to view code image](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9_images.xhtml#pch9ex02a)

[purplecab.com/driver/Bob](http://purplecab.com/driver/Bob)

Our system will append the dispatch information onto this URI and send it with a PUT, as follows:

[Click here to view code image](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9_images.xhtml#pch9ex03a)
...
[Click here to view code image](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9_images.xhtml#pch9ex04a)
...
[Click here to view code image](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9_images.xhtml#pch9ex05a)

|**URI**|**Dispatch Format**|
|---|---|
|`[Acme.com](http://acme.com/)`|`/pickupAddress/%s/pickupTime/%s/dest/%s`|
...
[1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch9.xhtml#ch9fn-1). Barbara Liskov, “Data Abstraction and Hierarchy,” _SIGPLAN Notices 23_, 5 (May 1988).