---
id: 01JF22HCXTPBKJB1V1VZETT1PN
modified: 2024-12-14T02:53:52-05:00
---
## 10  
ISP: THE INTERFACE SEGREGATION PRINCIPLE

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN10.jpg)

The Interface Segregation Principle (ISP) derives its name from the diagram shown in [Figure 10.1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch10.xhtml#ch10fig1).

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/10fig01.jpg)

**Figure 10.1** The Interface Segregation Principle

In the situation illustrated in [Figure 10.1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch10.xhtml#ch10fig1), there are several users who use the operations of the `OPS` class. Let’s assume that `User1` uses only `op1`, `User2` uses only `op2`, and `User3` uses only `op3`.
...
This problem can be resolved by segregating the operations into interfaces as shown in [Figure 10.2](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch10.xhtml#ch10fig2).
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/10fig02.jpg)
...
Consider, for example, an architect working on a system, S. He wants to include a certain framework, F, into the system. Now suppose that the authors of F have bound it to a particular database, D. So S depends on F. which depends on D ([Figure 10.3](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch10.xhtml#ch10fig3)).

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/10fig03.jpg)
...
We’ll explore this idea in more detail when we discuss the Common Reuse Principle in [Chapter 13](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch13.xhtml#ch13), “Component Cohesion.”