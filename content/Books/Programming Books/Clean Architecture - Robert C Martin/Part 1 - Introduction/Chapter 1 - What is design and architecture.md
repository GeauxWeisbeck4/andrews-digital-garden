---
id: 01JB5DR93CPG3Y17Z914JJP319
modified: 2024-10-26T18:05:45-04:00
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN01.jpg)
...
One of the goals of this book is to cut through all that confusion and to define, once and for all, what design and architecture are. For starters, I’ll assert that there is no difference between them. _None at all._
...
First, let’s look at the growth of the engineering staff. I’m sure you’ll agree that this trend is very encouraging. Growth like that shown in [Figure 1.1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig1) must be an indication of significant success!

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/01fig01.jpg)

**Figure 1.1** Growth of the engineering staff

_Reproduced with permission from a slide presentation by Jason Gorman_

Now let’s look at the company’s productivity over the same time period, as measured by simple lines of code ([Figure 1.2](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig2)).

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/01fig02.jpg)
...
Now here’s the really scary graph: [Figure 1.3](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig3) shows how the cost per line of code has changed over time.
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/01fig03.jpg)
...
[Figure 1.4](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig4) shows what this curve looks like to the developers. They started out at nearly 100% productivity, but with each release their productivity declined. By the fourth release, it was clear that their productivity was going to bottom out in an asymptotic approach to zero.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/01fig04.jpg)
...
If you think _that’s_ bad, imagine what this picture looks like to the executives! Consider [Figure 1.5](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig5), which depicts monthly development payroll for the same period.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/01fig05.jpg)
...
But now compare the curve in [Figure 1.5](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig5) with the lines of code written per release in [Figure 1.2](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch1.xhtml#ch1fig2). That initial few hundred thousand dollars per month bought a lot of functionality—but the final $20 million bought almost nothing! Any CFO would look at these two graphs and know that immediate action is necessary to stave off disaster.
...
Modern developers are in a similar race, and exhibit a similar overconfidence. Oh, they don’t sleep—far from it. Most modern developers work their butts off. But a part of their brain _does_ sleep—the part that knows that good, clean, well-designed code _matters_.
