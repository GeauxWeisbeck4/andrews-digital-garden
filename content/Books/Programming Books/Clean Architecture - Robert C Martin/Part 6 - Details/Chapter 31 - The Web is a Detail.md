---
id: 01JF23433VW4W6GSDAN2N8C384
modified: 2024-12-14T03:04:04-05:00
---
## 31  
THE WEB IS A DETAIL

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN31.jpg)
...
Think about it this way: _The WEB is an IO device_. In the 1960s, we learned the value of writing applications that were device independent. The motivation for that independence has not changed. The web is not an exception to that rule.
...
But another boundary between the UI and the application _can_ be abstracted. The business logic can be thought of as a suite of use cases, each of which performs some function on behalf of a user. Each use case can be described based on the input data, the processing preformed, and the output data.
