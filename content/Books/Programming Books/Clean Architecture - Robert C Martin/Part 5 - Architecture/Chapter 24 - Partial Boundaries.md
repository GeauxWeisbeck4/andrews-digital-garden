---
id: 01JF22XBDCZ8A5SV3GHQXJ5EWT
modified: 2024-12-14T03:00:24-05:00
---
## 24  
PARTIAL BOUNDARIES

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN24.jpg)
...
A simpler structure that serves to hold the place for later extension to a full-fledged boundary is shown in [Figure 24.1](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch24.xhtml#ch24fig1). It exemplifies the traditional _Strategy_ pattern. A `ServiceBoundary` interface is used by clients and implemented by `ServiceImpl` classes.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/24fig01.jpg)
...
An even simpler boundary is the _Facade_ pattern, illustrated in [Figure 24.2](https://learning.oreilly.com/library/view/clean-architecture-a/9780134494272/ch24.xhtml#ch24fig2). In this case, even the dependency inversion is sacrificed. The boundary is simply defined by the `Facade` class, which lists all the services as methods, and deploys the service calls to classes that the client is not supposed to access.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/24fig02.jpg)
