---
id: 01JF231KFDYRJVT1BPAAQF2ED5
modified: 2024-12-14T03:02:43-05:00
---
## 28  
THE TEST BOUNDARY

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780134494272/files/graphics/CH-UN28.jpg)

Yes, that’s right: _The tests are part of the system_, and they participate in the architecture just like every other part of the system does. In some ways, that participation is pretty normal. In other ways, it can be pretty unique.
...
This situation can become acute. Changes to common system components can cause hundreds, or even thousands, of tests to break. This is known as the _Fragile Tests Problem_.
...
The solution is to design for testability. The first rule of software design—whether for testability or for any other reason—is always the same: _Don’t depend on volatile things_. GUIs are volatile. Test suites that operate the system through the GUI _must be fragile_. Therefore design the system, and the tests, so that business rules can be tested without using the GUI.
