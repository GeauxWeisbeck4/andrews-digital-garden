---
id: 01JF1Z7M1DWEGQHH51XCABVP1Y
modified: 2024-12-14T01:56:06-05:00
---
## **1  
Clean Code**

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-1fig_martin.jpg)
...
I was recently reading the preface to Kent Beck’s book _Implementation Patterns._1 He says, “… this book is based on a rather fragile premise: that good code matters….” A _fragile_ premise? I disagree! I think that premise is one of the most robust, supported, and overloaded of all the premises in our craft (and I think Kent knows it). We know good code matters because we’ve had to deal for so long with its lack.

1. [[Beck07](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#Beck07)].
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-2fig_martin.jpg)
...
As the mess builds, the productivity of the team continues to decrease, asymptotically approaching zero. As productivity decreases, management does the only thing they can; they add more staff to the project in hopes of increasing productivity. But that new staff is not versed in the design of the system. They don’t know the difference between a change that matches the design intent and a change that thwarts the design intent. Furthermore, they, and everyone else on the team, are under horrific pressure to increase productivity. So they all make more and more messes, driving the productivity ever further toward zero. (See [Figure 1-1](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#ch1fig1).)

**Figure 1-1** Productivity vs. time

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-4fig_martin.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-5fig_martin.jpg)

**Bjarne Stroustrup, inventor of C++ and author of _The C++ Programming Language_**
...
Bjarne also mentions efficiency—_twice_. Perhaps this should not surprise us coming from the inventor of C++; but I think there’s more to it than the sheer desire for speed. Wasted cycles are inelegant, they are not pleasing. And now note the word that Bjarne uses to describe the consequence of that inelegance. He uses the word “tempt.” There is a deep truth here. Bad code _tempts_ the mess to grow! When others change bad code, they tend to make it worse.
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-6fig_martin.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-7fig_martin.jpg)
...
Dave also says that code should be _literate_. This is a soft reference to Knuth’s _literate programming._4 The upshot is that the code should be composed in such a form as to make it readable by humans.

4. [[Knuth92](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#Knuth92)].

**Michael Feathers, author of _Working Effectively with Legacy Code_**

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-8fig_martin.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-9fig_martin.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-10fig_martin.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:9780136083238/files/images/1-11fig_martin.jpg)

Martial artists do not all agree about the best martial art, or the best technique within a martial art. Often master martial artists will form their own schools of thought and gather students to learn from them. So we see _Gracie Jiu Jistu_, founded and taught by the Gracie family in Brazil. We see _[Hakkoryu Jiu Jistu](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#ch1see1)_, founded and taught by Okuyama Ryuho in Tokyo. We see _[Jeet Kune Do](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#ch1see2)_, founded and taught by Bruce Lee in the United States.
...
_Bob enters the module.  
He scrolls down to the function needing change.  
He pauses, considering his options.  
Oh, he’s scrolling up to the top of the module to check the initialization of a variable.  
Now he scrolls back down and begins to type_.  
_Ooops, he’s erasing what he typed!_  
_He types it again.  
He erases it again!  
...
He pops up another window and looks at a subclass. Is that function overridden?_
...
_Leave the campground cleaner than you found it.5_
...
**[[Beck07](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#iBeck07)]:** _Implementation Patterns_, Kent Beck, Addison-Wesley, 2007.

**[[Knuth92](https://learning.oreilly.com/library/view/clean-code-a/9780136083238/chapter01.xhtml#iKnuth92)]:** _Literate Programming_, Donald E. Knuth, Center for the Study of Language and Information, Leland Stanford Junior University, 1992.